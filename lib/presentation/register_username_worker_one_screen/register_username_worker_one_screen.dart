...
class RegisterUsernameWorkerOneScreen extends StatelessWidget {
  RegisterUsernameWorkerOneScreen({Key? key}) : super(key: key);
    ...
    return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(left: 9.h),
                  child: Text("Farm’s Name", style: theme.textTheme.bodyLarge)),
              SizedBox(height: 1.v),
              Opacity(
                  opacity: 0.8,
                  child: Padding(
