...
class RegisterUsernameLandOwnerScreen extends StatelessWidget {
  RegisterUsernameLandOwnerScreen({Key? key}) : super(key: key);
        ...
        child: Column(
            ...
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(left: 9.h),
                  child:
                      Text("Land address", style: theme.textTheme.bodyLarge)),
              SizedBox(height: 2.v),
              Opacity(
                  opacity: 0.8,
                  child: Padding(
